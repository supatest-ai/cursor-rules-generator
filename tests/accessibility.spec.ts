...
test.describe('Accessibility', () => {
  ...
  test('should have proper page title and meta description', async ({ page }) => {
    ...
    await page.screenshot({ path: 'accessibility-page-meta.png', fullPage: true });
  });
  ...
  test('should support keyboard navigation', async ({ page }) => {
    ...
    await page.screenshot({ path: 'keyboard-navigation-test.png', fullPage: true });
  });
  ...
  test('should have proper form labels and associations', async ({ page }) => {
    ...
    await page.screenshot({ path: 'form-labels-accessibility.png', fullPage: true });
  });
  ...
  test('should support screen reader announcements', async ({ page }) => {
    ...
    await page.screenshot({ path: 'screen-reader-support.png', fullPage: true });
  });
  ...
  test('should have sufficient color contrast', async ({ page }) => {
    ...
    await page.screenshot({ path: 'color-contrast-check.png', fullPage: true });
  });
  ...
  test('should handle focus management in modals', async ({ page }) => {
    ...
    await page.screenshot({ path: 'modal-focus-management.png', fullPage: true });
  });
  ...
  test('should provide alternative text for images', async ({ page }) => {
    ...
    await page.screenshot({ path: 'image-alt-text.png', fullPage: true });
  });
  ...
  test('should support reduced motion preferences', async ({ page }) => {
    ...
    await page.screenshot({ path: 'reduced-motion-support.png', fullPage: true });
  });
  ...
  test('should provide clear error messages and validation feedback', async ({ page }) => {
    ...
    await page.screenshot({ path: 'validation-feedback.png', fullPage: true });
  });
  ...
  test('should maintain accessibility during state changes', async ({ page }) => {
    ...
    await page.screenshot({ path: 'state-change-accessibility.png', fullPage: true });
  });
  ...
  test('should support high contrast mode', async ({ page }) => {
    ...
    await page.screenshot({ path: 'high-contrast-mode.png', fullPage: true });
  });
}); 